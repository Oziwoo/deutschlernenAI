...
const strings = {
  ...
  nav_listen:        { en: 'Listen',      pl: 'Słuchaj'     },
  ...
  dash_action_listen:{ en: 'Listen & Type',          pl: 'Słuchaj i pisz'            },
  dash_action_listen_sub:{ en: 'Hear the word and type it', pl: 'Usłysz słowo i je wpisz' },
  ...
  dash_chart_title:  { en: 'Words studied this week', pl: 'Słowa przećwiczone w tym tygodniu' },
  ...
  // ── ListeningMode ─────────────────────────────────────────────────
  listen_back:         { en: '← Back',                   pl: '← Wróć'                       },
  listen_placeholder:  { en: 'Type what you heard…',     pl: 'Wpisz co usłyszałeś…'         },
  listen_tip:          { en: 'Tip: type ue→ü, ae→ä, oe→ö, ss→ß', pl: 'Wskazówka: ue→ü, ae→ä, oe→ö, ss→ß' },
  listen_check:        { en: 'Check',                    pl: 'Sprawdź'                       },
  listen_answer_was:   { en: 'The correct answer was:',  pl: 'Poprawna odpowiedź to:'        },
  listen_retry:        { en: 'Try again',                pl: 'Spróbuj ponownie'              },
  listen_next:         { en: 'Next word →',              pl: 'Następne słowo →'              },
  listen_done_title:   { en: 'Session complete!',        pl: 'Sesja zakończona!'             },
  listen_done_sub:     { en: 'Words practiced: {n}',     pl: 'Przećwiczone słowa: {n}'       },
  listen_another:      { en: 'Another round',            pl: 'Jeszcze runda'                 },
  listen_home:         { en: 'Home',                     pl: 'Start'                         },
  listen_score_correct:{ en: 'Correct',                  pl: 'Poprawnie'                     },
  listen_score_wrong:  { en: 'Wrong',                    pl: 'Błędnie'                       },
  listen_no_tts:       { en: 'Your browser does not support text-to-speech. Try Chrome or Edge.', pl: 'Twoja przeglądarka nie obsługuje syntezy mowy. Użyj Chrome lub Edge.' },
  ...
  browse_conj_show:  { en: 'Show conjugation',       pl: 'Pokaż koniugację'          },
  browse_conj_loading:{ en: 'Loading conjugation…',  pl: 'Ładuję koniugację…'        },
  browse_conj_error: { en: 'Failed to load conjugation', pl: 'Nie udało się załadować koniugacji' },
  browse_praesens:   { en: 'Present (Präsens)',       pl: 'Czas teraźniejszy (Präsens)' },
  browse_perfekt:    { en: 'Perfect (Perfekt)',        pl: 'Czas dokonany (Perfekt)'  },
  browse_praeteritum:{ en: 'Past (Präteritum)',        pl: 'Czas przeszły (Präteritum)' },
  browse_imperativ:  { en: 'Imperative',              pl: 'Tryb rozkazujący'          },
